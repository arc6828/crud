                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Order Id </th><td> {{ $orderproduct->order_id }} </td></tr><tr><th> Product Id </th><td> {{ $orderproduct->product_id }} </td></tr><tr><th> User Id </th><td> {{ $orderproduct->user_id }} </td></tr><tr><th> Quantity </th><td> {{ $orderproduct->quantity }} </td></tr>
                                </tbody>
                            </table>
                        </div>
